...
public class AastockStockQuoteParserTest {
    ...
    AastockStockQuoteParser parser = new AastockStockQuoteParser(Dsl.asyncHttpClient());

	@Test
	public void getStockQuote_Given941_ShouldReturn941StockQuote() {
        Stopwatch timer = Stopwatch.createStarted();

        CompletableFuture<Optional<StockQuote>> quote = parser.query( "941");
    ...
    public void getStockQuote_Given2800_ShouldReturn2800StockQuote() {
        ...
        CompletableFuture<Optional<StockQuote>> quote = parser.query( "2800");
        StockQuote q = quote.join().get();
