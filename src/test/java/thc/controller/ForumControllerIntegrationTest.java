...
public class ForumControllerIntegrationTest {
	...
	@Test
	public void list_MusicPage1_ShouldReturnDescendingForumThreadsNotOlderThanConfig_old() {
		Stopwatch timer = Stopwatch.createStarted();

		List<ForumThread> contents = controller.oldlist("MUSIC", 1);
	...
	@Test
	public void list_MoviePage1_ShouldReturnDescendingForumThreadsNotOlderThanConfig_old() {
		Stopwatch timer = Stopwatch.createStarted();

		List<ForumThread> contents = controller.oldlist("MOVIE", 1);
