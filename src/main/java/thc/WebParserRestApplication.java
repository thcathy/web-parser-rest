...
public class WebParserRestApplication {
	...
	public static AsyncHttpClient httpClient() {
		...
		return asyncHttpClient(config().setUserAgent("Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.103 Safari/537.36").setSslContext(sslContext));
	}
